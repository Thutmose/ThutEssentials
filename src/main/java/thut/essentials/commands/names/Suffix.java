...
public class Suffix extends BaseCommand
{
    ...
    public void execute(MinecraftServer server, ICommandSource sender, String[] args) throws CommandException
    {
        ...
        {
            sender.sendMessage(
                    new StringTextComponent("Set Suffix for " + player.getDisplayNameString() + " to " + arg));
        }
        else
        {
            sender.sendMessage(new StringTextComponent("Reset Set Suffix for " + player.getDisplayNameString()));
        }
        nametag.putString("suffix", arg);
