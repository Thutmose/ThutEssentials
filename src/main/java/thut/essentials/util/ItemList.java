...
public class ItemList extends Items
{
    ...
    {
        var tagkey = E_TAGS.computeIfAbsent(tag, l -> TagKey.create(Registries.ENTITY_TYPE, l));
    ...
    {
        var tagkey = B_TAGS.computeIfAbsent(tag, l -> TagKey.create(Registries.BLOCK, l));
    ...
    {
        var tagkey = I_TAGS.computeIfAbsent(tag, l -> TagKey.create(Registries.ITEM, l));
